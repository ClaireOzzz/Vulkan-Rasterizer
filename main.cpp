...
class RasElement : public nvapp::IAppElement
{
public:

  RasElement() = default;
  ~RasElement() override = default;
...
int main(int argc, char** argv)
{
  ...
  std::shared_ptr<RasElement> rasElement = std::make_shared<RasElement>();
